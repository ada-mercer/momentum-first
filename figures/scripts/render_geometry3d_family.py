#!/usr/bin/env python3
"""Render all implemented scenes in one geometry3d family."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description='Render one geometry3d family.')
    parser.add_argument('family', help='Geometry3d family slug, for example foundations-shells.')
    parser.add_argument('--backend', help='Backend override for all family scenes. Without this, runtime uses the family default from the manifest.')
    parser.add_argument('--camera', help='Camera preset override for all family scenes.')
    parser.add_argument('--style', help='Style preset override for all family scenes.')
...
def main() -> int:
    ...
    try:
        ...
        print(f'geometry3d family render failed: {exc}')
