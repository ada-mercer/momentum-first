...
Part III develops this order step by step. The next chapter introduces the gravity-side vocabulary needed to make the picture precise: the source quantities, the field variables, and the local-readout quantities through which gravitational structure becomes observable kinematics.
