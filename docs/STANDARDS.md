...
- `manuscript/chapters/**/*.qmd`
- `manuscript/appendices/**/*.qmd`
...
- chapter-local `manuscript/chapters/**/AUTHOR_NOTES.md`
- `docs/BOOK_STRUCTURE_PLAN.md`
- `docs/STYLE_FLOW_GUIDE.md`
...
- `manuscript/chapters/00-front-matter/00-preface/index.qmd` is the unnumbered Preface wrapper.
- `manuscript/chapters/01-tier-1-foundations/01-introduction/index.qmd` is Chapter 1, Introduction.
...
- Part boundaries should be slow to change and should follow `docs/BOOK_STRUCTURE_PLAN.md`.
...
- Directories under `manuscript/chapters/` should align with current or planned part/chapter clusters, but `_quarto.yml` decides what renders.

Before committing manuscript-structure changes:
- check `_quarto.yml` paths,
- check moved/deleted chapter files against references and `docs/BOOK_STRUCTURE_PLAN.md`,
- update `manuscript/chapters/README.md` if the live structure changed,
...
`docs/VERIFICATION_POLICY.md` is the canonical policy for claim roles, regime discipline, and review tiers.
...
- Long derivations in `manuscript/appendices/derivations/` should not be treated as accepted without V3 review.
...
`docs/STYLE_FLOW_GUIDE.md` is the working guide for manuscript readability, flow, and rhetorical control.
