...
- Long derivations should move to `manuscript/appendices/derivations/` once they interrupt narrative flow.
...
Rendered files:
- `index.qmd`
- `manuscript/chapters/00-front-matter/00-preface/index.qmd`
...
Rendered files:
1. `manuscript/chapters/01-tier-1-foundations/01-introduction/index.qmd` — **Introduction**
2. `manuscript/chapters/01-tier-1-foundations/02-foundations/index.qmd` — **Foundations**
...
- **Result:** `docs/BOOK_STRUCTURE_PLAN.md` now reflects Tier 1 Foundations, Tier 2 Engines, Tier 3 Tests/Predictions/Failure Modes, and later-reading-order Tier 0 Deep Structure / Sub-Particle Models. The previous mature-engine / speculative-deep-structure split has been removed.
